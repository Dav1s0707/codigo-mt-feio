...
public class labrintogames {
	...
	public static void main(String[] args) {
		...
		// regras
		System.out.println("Para complentar esse desafio seu robô deve chegar ao outro lado do labirinto");
		...
		System.out.println("");
		System.out.println("Alem disso será nescessario uma bateria de 30V, cada passo custara 1V");
		...
		if (direcao.equalsIgnoreCase("direita") && passos == 5) {
						...
						if (direcao.equalsIgnoreCase("esquerda") && passos == 2) {
							...
							if (bateria <= 0) {
								...
								if (direcao.equalsIgnoreCase("tras") && passos == 2) {
									...
									else {System.out.println("Qual será a proxima direção");
									direcao = in.next();
									System.out.println("Quanto passos ele andará:");
									passos = in.nextInt();
